...
export const organizations = [
  { name: "ООО «АгроСнаб»", type: "Покупатель", region: "Саратовская область", rating: 4.8, x: 46, y: 44 },
  { name: "КФХ Иванов", type: "Поставщик", region: "Воронежская область", rating: 4.9, x: 34, y: 59 },
  { name: "ФГБУ «Саратовская МИС»", type: "Учреждение", region: "Саратовская область", rating: 4.8, x: 61, y: 38 },
  { name: "ООО «АгроДрон»", type: "Услуги", region: "Саратовская область", rating: 4.9, x: 72, y: 57 },
  { name: "КФХ Петров", type: "Поставщик", region: "Саратовская область", rating: 5.0, x: 52, y: 70 },
  { name: "Фермерское хозяйство Сидорова", type: "Поставщик", region: "Саратовская область", rating: 5.0, x: 58, y: 64 }
];