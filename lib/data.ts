...
export const organizations = [
  { name: "ООО «АгроСнаб»", type: "Покупатель", region: "Саратовская область", rating: 4.8, x: 46, y: 44, coordinates: [46.0342, 51.5336] as [number, number] },
  { name: "КФХ Иванов", type: "Поставщик", region: "Воронежская область", rating: 4.9, x: 34, y: 59, coordinates: [39.2003, 51.6608] as [number, number] },
  { name: "ФГБУ «Саратовская МИС»", type: "Учреждение", region: "Саратовская область", rating: 4.8, x: 61, y: 38, coordinates: [46.0703, 51.5686] as [number, number] },
  { name: "ООО «АгроДрон»", type: "Услуги", region: "Саратовская область", rating: 4.9, x: 72, y: 57, coordinates: [46.0208, 51.4952] as [number, number] },
  { name: "КФХ Петров", type: "Поставщик", region: "Саратовская область", rating: 5.0, x: 52, y: 70, coordinates: [45.9521, 51.6025] as [number, number] }
];