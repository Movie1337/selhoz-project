...
export default function Footer() {
  return <footer style={{background:"var(--green-dark)",color:"#fff",marginTop:70}}>
    <div className="container" style={{padding:"50px 0 28px",display:"grid",gridTemplateColumns:"2fr 1fr 1fr 1fr",gap:30}}>
      <div><div style={{fontSize:22,fontWeight:900,marginBottom:12}}>АгроСвязь</div><p style={{color:"#cbd9ce",lineHeight:1.7,maxWidth:390}}>Цифровая площадка для производителей, покупателей и организаций аграрного сектора.</p></div>
      ...
      <div><b>Поддержка</b><div style={{display:"grid",gap:10,marginTop:14,color:"#cbd9ce"}}><span>support@agrosvyaz.ru</span><span>Политика конфиденциальности</span><span>Условия использования</span></div></div>
    </div>
    <div className="container" style={{borderTop:"1px solid rgba(255,255,255,.12)",padding:"18px 0",color:"#9fb1a2",fontSize:13}}>© 2026 АгроСвязь. Концепт MVP.</div>
  </footer>;
}