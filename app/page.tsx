    ...
    <main>
      ...
      <section style={{background:"#edf3e8"}}>
        <div className="container" style={{padding:"68px 0"}}>
          <div style={{maxWidth:700}}><div className="muted" style={{fontSize:13,fontWeight:800}}>ПОЧЕМУ АГРОМОСТ</div><h2 style={{fontSize:38,margin:"8px 0 14px"}}>Один рынок вместо десятков разрозненных каналов</h2><p className="muted" style={{lineHeight:1.7}}>Логика платформы построена вокруг конкретного действия: найти нужный товар или услугу, проверить контрагента и связаться напрямую.</p></div>
